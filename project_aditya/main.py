...
with open('2020_acoe.csv') as f1 :
    data = list(csv.reader(f1))
    data = data[1:]
# print(data[0])

with open('2020_acoe_log.csv', 'w', newline='') as log:
    c = 0
    sc = 0
    fc = 0
    writer = csv.writer(log)
    for d in data:
        image_url = "https://info.aec.edu.in/acoe/StudentPhotos/"+d[1]+".jpg"
        download_folder = "acoe_2020"
